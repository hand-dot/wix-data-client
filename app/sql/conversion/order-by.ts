...
export function convertOrderByExp(convertionObj: ConvertionObj, parsedInputArr: string[], index: number) {
...
function analyzeOrderByRes(convertionObj: ConvertionObj, expectAnotherColumn: boolean, lastEncounteredColumn: string | null) {
    let orderByObj: { [key: string]: any } = {};
    if (lastEncounteredColumn !== null) {
        orderByObj[lastEncounteredColumn] = 'asc';
        convertionObj.orderBy.push(orderByObj);
