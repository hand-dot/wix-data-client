...
export function convertSelectExp(convertionObj: ConvertionObj, parsedInputArr: string[], index: number) {
    ...
    convertCollectionName(convertionObj, parsedInputArr, jumpToIndex as number);
    return jumpToIndex;
}

function convertQueriedColumns(convertionObj: ConvertionObj, parsedInputArr: string[], index: number) {
...
function analyzeQueriedColumnsRes(convertionObj: ConvertionObj, foundFROM: boolean, expectAnotherColumn: boolean) {
    if (!foundFROM) {
...
function convertFunctionsQueriedColumns(convertionObj: ConvertionObj, parsedInputArr: string[], index: number) {
