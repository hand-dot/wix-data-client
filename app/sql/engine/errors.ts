export let errors = [
    ...
    { code: '27', message: `Syntax error near "SELECT". Reason: missing or illegal parentheses stracture. Expected all columns to be wrapped with functions, in the following structure: <Function><open parentheses><Column><close parentheses>` },
