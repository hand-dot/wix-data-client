...
export function buildWixDataQuery(collectionName: string, filterObj: any, anotherCondType: string) {
    let first = true;
...
export function addOrderByToQuery(prevWixDataFunc: any, orderByArr: any) {
...
export function addLimitToQuery(prevWixDataFunc: any, convertionObj: ConvertionObj) {
    let wixDataFunc = prevWixDataFunc;
...
export function buildWixDataAggregateQuery(convertionObj: ConvertionObj) {
...
export function buildWixDataFilter(convertionObj: ConvertionObj) {
